Please also provide proposed fixes
...
pub struct FfiImageLayer {
    ...
    pub width: u32,
    pub height: u32,
    /// Must be aligned to 256 bytes for Vulkan/D3D12 linear upload compatibility
...
* Plugins export a standard C entry symbol: `extern "C" fn init_plugin() -> FfiDecoderPlugin`.
